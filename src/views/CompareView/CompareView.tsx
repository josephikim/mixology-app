    ...
    return (
      <ContentWrapper>
        ...
        <Form {...layout} name="nest-messages" layout="vertical">
          ...
          <Button type="primary" htmlType="button" loading={this.props.state.demo.loading} onClick={() => this.login()}>
            Login
          </Button>
          <Button type="primary" danger htmlType="button" onClick={() => this.logout()} style={{ marginLeft: 10 }}>
            Logout
          </Button>
        </Form>
      </ContentWrapper>
